...
public class C01_SoftAssert {
    ...
    public void test01(){
        ...
        String aramaSonucYazisi=amazonPage.amazonActualKelime.getText();
        ...
        System.out.println(amazonPage.amazonActualKelime.getText());
        aramaSonucYazisi=amazonPage.amazonActualKelime.getText();
